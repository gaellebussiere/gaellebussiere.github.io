...
C'est avec cette intention, partager mes "pensées en culture", que je développe cet espace numérique. Je l'imagine comme "mon jardin numérique". Ces pensées sont cultivés à l'aide d'engrais (mes lectures, mes écoutes, mes discussions). Elles sont en développement. Certaines grandiront mieux que d'autres. C'est bien normal et finalement peu important car mon objectif est uniquement celui du perfectionnement (et non du perfectionnisme). 
